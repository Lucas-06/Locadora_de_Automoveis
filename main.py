...
def estoque_automoveis():
    automoveis = [
        ("Chevrolet Onix", 54),
        ("Chevrolet Onix Plus", 59),
        ("Chevrolet Cruze Sport6", 74),
        ("Chevrolet Tracker", 79),
        ("Chevrolet Equinox", 109)
    ]

    alugados = []

    return automoveis, alugados
...
def execute():
    limpar_tela()
    carros, alugados = estoque_automoveis()  # Inicializando o estoque de carros
    main(carros, alugados)
